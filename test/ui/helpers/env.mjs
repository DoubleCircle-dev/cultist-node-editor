 ...
 *
 * @returns {Promise<{ core: import('../../../frontend/src-legacy/controllers/controllerCore.js').ControllerCore, viewport: HTMLElement, world: HTMLElement }>}
 */
export async function createCore() {
  const { ControllerCore } = await import('../../../frontend/src-legacy/controllers/controllerCore.js');
 ...
 *
 * @param {import('../../../frontend/src-legacy/controllers/controllerCore.js').ControllerCore} core
 */
